...
part of 'requested_reviewer.dart';
...
/// @nodoc
abstract mixin class $RequestedReviewerCopyWith<$Res>  {
  factory $RequestedReviewerCopyWith(RequestedReviewer value, $Res Function(RequestedReviewer) _then) = _$RequestedReviewerCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [RequestedReviewer].
extension RequestedReviewerPatterns on RequestedReviewer {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RequestedReviewer value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RequestedReviewer() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RequestedReviewer value)  $default,){
final _that = this;
switch (_that) {
case _RequestedReviewer():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RequestedReviewer value)?  $default,){
final _that = this;
switch (_that) {
case _RequestedReviewer() when $default != null:
return $default(_that);case _:
...
class _RequestedReviewer implements RequestedReviewer {
   _RequestedReviewer({required this.login, required this.id, required this.nodeId, required this.avatarUrl, required this.gravatarId, required this.url, required this.htmlUrl, required this.followersUrl, required this.followingUrl, required this.gistsUrl, required this.starredUrl, required this.subscriptionsUrl, required this.organizationsUrl, required this.reposUrl, required this.eventsUrl, required this.receivedEventsUrl, required this.type, required this.siteAdmin});
  factory _RequestedReviewer.fromJson(Map<String, dynamic> json) => _$RequestedReviewerFromJson(json);
...
@pragma('vm:prefer-inline')
_$RequestedReviewerCopyWith<_RequestedReviewer> get copyWith => __$RequestedReviewerCopyWithImpl<_RequestedReviewer>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RequestedReviewerToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RequestedReviewer&&(identical(other.login, login) || other.login == login)&&(identical(other.id, id) || other.id == id)&&(identical(other.nodeId, nodeId) || other.nodeId == nodeId)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.gravatarId, gravatarId) || other.gravatarId == gravatarId)&&(identical(other.url, url) || other.url == url)&&(identical(other.htmlUrl, htmlUrl) || other.htmlUrl == htmlUrl)&&(identical(other.followersUrl, followersUrl) || other.followersUrl == followersUrl)&&(identical(other.followingUrl, followingUrl) || other.followingUrl == followingUrl)&&(identical(other.gistsUrl, gistsUrl) || other.gistsUrl == gistsUrl)&&(identical(other.starredUrl, starredUrl) || other.starredUrl == starredUrl)&&(identical(other.subscriptionsUrl, subscriptionsUrl) || other.subscriptionsUrl == subscriptionsUrl)&&(identical(other.organizationsUrl, organizationsUrl) || other.organizationsUrl == organizationsUrl)&&(identical(other.reposUrl, reposUrl) || other.reposUrl == reposUrl)&&(identical(other.eventsUrl, eventsUrl) || other.eventsUrl == eventsUrl)&&(identical(other.receivedEventsUrl, receivedEventsUrl) || other.receivedEventsUrl == receivedEventsUrl)&&(identical(other.type, type) || other.type == type)&&(identical(other.siteAdmin, siteAdmin) || other.siteAdmin == siteAdmin));
}
...
/// @nodoc
abstract mixin class _$RequestedReviewerCopyWith<$Res> implements $RequestedReviewerCopyWith<$Res> {
  factory _$RequestedReviewerCopyWith(_RequestedReviewer value, $Res Function(_RequestedReviewer) _then) = __$RequestedReviewerCopyWithImpl;
@override @useResult
$Res call({
 String? login, int? id, String? nodeId, String? avatarUrl, String? gravatarId, String? url, String? htmlUrl, String? followersUrl, String? followingUrl, String? gistsUrl, String? starredUrl, String? subscriptionsUrl, String? organizationsUrl, String? reposUrl, String? eventsUrl, String? receivedEventsUrl, String? type, bool? siteAdmin
});
...
/// @nodoc
class __$RequestedReviewerCopyWithImpl<$Res>
    implements _$RequestedReviewerCopyWith<$Res> {
  __$RequestedReviewerCopyWithImpl(this._self, this._then);

  final _RequestedReviewer _self;
  final $Res Function(_RequestedReviewer) _then;

/// Create a copy of RequestedReviewer
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? login = freezed,Object? id = freezed,Object? nodeId = freezed,Object? avatarUrl = freezed,Object? gravatarId = freezed,Object? url = freezed,Object? htmlUrl = freezed,Object? followersUrl = freezed,Object? followingUrl = freezed,Object? gistsUrl = freezed,Object? starredUrl = freezed,Object? subscriptionsUrl = freezed,Object? organizationsUrl = freezed,Object? reposUrl = freezed,Object? eventsUrl = freezed,Object? receivedEventsUrl = freezed,Object? type = freezed,Object? siteAdmin = freezed,}) {
  return _then(_RequestedReviewer(
login: freezed == login ? _self.login : login // ignore: cast_nullable_to_non_nullable
as String?,id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,nodeId: freezed == nodeId ? _self.nodeId : nodeId // ignore: cast_nullable_to_non_nullable
as String?,avatarUrl: freezed == avatarUrl ? _self.avatarUrl : avatarUrl // ignore: cast_nullable_to_non_nullable
