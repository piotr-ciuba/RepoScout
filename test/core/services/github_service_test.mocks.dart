...
// in repo_scout_app/test/core/services/github_service_test.dart.
...
class _FakeEndpoints_1 extends _i1.SmartFake implements _i3.Endpoints {
  _FakeEndpoints_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockApiClient extends _i1.Mock implements _i4.ApiClient {
  ...
  @override
  _i3.Endpoints get endpoints =>
      (super.noSuchMethod(
            Invocation.getter(#endpoints),
            returnValue: _FakeEndpoints_1(this, Invocation.getter(#endpoints)),
          )
          as _i3.Endpoints);
}
...
class MockEndpoints extends _i1.Mock implements _i3.Endpoints {
  ...
  String pullRequestsUrl({required String? owner, required String? repo}) =>
      (super.noSuchMethod(
            Invocation.method(#pullRequestsUrl, [], {
              #owner: owner,
              #repo: repo,
            }),
            returnValue: _i6.dummyValue<String>(
  ...
  String issuesUrl({required String? owner, required String? repo}) =>
      (super.noSuchMethod(
            Invocation.method(#issuesUrl, [], {#owner: owner, #repo: repo}),
            returnValue: _i6.dummyValue<String>(
              this,
              Invocation.method(#issuesUrl, [], {#owner: owner, #repo: repo}),
            ),
